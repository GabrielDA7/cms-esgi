<section id="dashboard-list-video" class="table-data">
  ...
  <div class="row row-tools">
    ...
    <div class="M2 M--offset6">
      <a class="btn-extra-small btn-filled-orange btn btn-icon" href="<?= DIRNAME . VIDEO_ADD_BACK_LINK; ?>">Add<i class="fas fa-plus"></i></a>
    </div>
  </div>
